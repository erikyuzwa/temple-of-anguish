    ...
    handleInput: function(inputType, inputData) {
        ...
        if (inputType === 'keydown') {
          ...
          if (inputData.keyCode === ROT.VK_LEFT) {
            ...
            this.showItemsSubScreen(Game.Screen.wieldScreen, this._player.getItems(), 'Nothing to wield.');

            return;
          } else if (inputData.keyCode === ROT.VK_W) {
            // Show the wear screen
            this.showItemsSubScreen(Game.Screen.wearScreen, this._player.getItems(), 'Nothing to wear.');
            return;
