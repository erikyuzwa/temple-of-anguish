...
/*
const DynamicGlyph = function(properties) {
...
//extend(DynamicGlyph, Glyph)
//extend(Glyph, DynamicGlyph)
//_.merge(DynamicGlyph, Glyph)
...
//var test = Object.assign(DynamicGlyph, Glyph)
//var test = _.cloneDeep(DynamicGlyph, Glyph)
//var test = extend(Glyph, DynamicGlyph)
//const thing = new test()
//console.log(thing.getChar())
//console.log(test.getChar())
//debugger
